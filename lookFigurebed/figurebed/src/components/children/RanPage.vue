      ...
      <div class="com">
        ...
        <div class="head">
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>随机图库管理</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
        <el-card class="box-card">
          ...
          <div class="demo-image">
            ...
            <el-upload
                ...
                :action="serverUrl+'/ran/massUpload'"
          ...
          <el-form :inline="true" label-width="auto">
            <el-form-item><div style="width: 35vh;"></div></el-form-item>
...
export default {
  ...
  data(){
    ...
    this.$axios.post("/ran/getImg", this.pageBean)
        .then(res => {
  ...
  methods:{
    handleRemove(uploadFile){
      this.$axios.post("/ran/delImg", [{name:uploadFile.name}])
          .then(res => {
            if(res.data.code === 200){
